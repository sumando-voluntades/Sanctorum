...
async function cargarNotificaciones() {
    ...
    try {
        ...
        // Encuestas de Satisfacción desactivado por completo (ya no se usará) — se quita esta
        // notificación. La tarjeta "Encuestas por Revisar" en Perfil, a la que apuntaba, también
        // está comentada.
