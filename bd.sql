...
CREATE TABLE public.donaciones (
  ...
  categoria_gasto character varying,
...
CREATE TABLE public.eventos (
  ...
  CONSTRAINT eventos_id_responsable_fkey FOREIGN KEY (id_responsable) REFERENCES public.usuarios(id_usuario)
);
...
CREATE TABLE public.reportes_evento (
  ...
  url_adjuntos text[] NOT NULL DEFAULT '{}',
